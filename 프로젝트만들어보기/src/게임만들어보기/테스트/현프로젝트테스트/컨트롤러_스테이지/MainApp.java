...
public class MainApp extends Application {
	...
	@Override
	public void start(Stage primaryStage) throws Exception, ArrayIndexOutOfBoundsException {
		...
		scene.getStylesheets().add(getClass().getResource("strokeOp.css").toString());
